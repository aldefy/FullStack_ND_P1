...
def init_movies():
    ...
    media.Movie("The Shawshank Redemption",
                ...
                "._V1_QL50_SY1000_CR0,0,672,1000_AL_.jpg",
    ...
    media.Movie("The Godfather",
                ...
                "MV5BZTRmNjQ1ZDYtNDgzMy00O" +
                "GE0LWE4N2YtNTkzNWQ5ZDhlN" +
                "GJmL2ltYWdlL2ltYWdlXkEyXkFqcGdeQXVyNjU0OTQ0OTY@" +
                "._V1_QL50_SY1000_CR0,0,704,1000_AL_.jpg",
                "https://www.youtube.com/watch?v=sY1S34973zA",
                "1972")
    sound_of_music =
    media.Movie("The Sound of Music",
                "The early life and career of Vito Corleone in 1920s" +
                " New York is portrayed while his son," +
                " Michael, expands and tightens his grip on the family" +
                ".crime syndicate",
                "https://images-na.ssl-images-amazon.com/images/" +
                "M/MV5BODIxNjhkYjEtYzUyMi00YTNjLWE1YjktNjAyY2I2" +
                "MWNkNmNmL2ltYWdlL2ltYWdlXkEyXkFqcGdeQXVyMTQxNzMzNDI@" +
                "._V1_QL50_SX705_CR0,0,705,999_AL_.jpg",
                "https://www.youtube.com/watch?v=OyzzifE1YGs",
                "1965")
    dark_knight =
    media.Movie("The Dark Knight",
                "When the menace known as the Joker emerges from his" +
                " mysterious past, he wreaks havoc and chaos " +
                "on the people of Gotham, the Dark Knight must accept one of" +
                " the greatest psychological and physical " +
                "tests of his ability to fight injustice.",
                "https://images-na.ssl-images-amazon.com/images/" +
                "M/MV5BMTMxNTMwODM0NF5BMl5BanBnXkFtZTcwODAyMTk2Mw@@" +
                "._V1_QL50_SY1000_CR0,0,675,1000_AL_.jpg",
    ...
    movies = [shawshank_redemption, martian, god_father,
              sound_of_music, dark_knight, inception]
